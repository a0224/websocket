...
public class RequestFactory {
    ...
    private static Queue<MessageRequest> MESSAGE_REQUEST_POOL = new ArrayDeque<>(POLL_SIZE);
    ...
    public static Request<WebSocketMessage> createMessageRequest() {
        Request<WebSocketMessage> request = MESSAGE_REQUEST_POOL.poll();
        if (request == null) {
    ...
    static void releaseMessageRequest(MessageRequest request) {
        MESSAGE_REQUEST_POOL.offer(request);
    }
